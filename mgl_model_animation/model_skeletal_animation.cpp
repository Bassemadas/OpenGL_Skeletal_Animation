...
int model_skeletal_animation()
{
	...
	ourModel.LoadMesh("resources/Models/oliver/source/oliver shot.fbx");
	//ourModel.LoadMesh("resources/Models/running/model.dae");
	//ourModel.LoadMesh("resources/Models/bob_lamp_update/boblampclean.md5mesh");
